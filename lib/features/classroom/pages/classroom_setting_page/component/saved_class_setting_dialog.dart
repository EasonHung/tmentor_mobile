...
import '../../classroom_list_page/controller/classroom_list_ws_controller.dart';
import '../controller/class_setting_controller.dart';

class SavedClassSettingDialog {
  ...
  SavedClassSettingDialog(this.context);
    ...
    return Container(
        ...
        child: Row(
          children: [
            ...
            TextButton(
                onPressed: () async {
                  if(classSettingController.selectedClassSetting.value == null) {
                    ToastService.showAlert("請選擇課程設定");
                    return;
                  }
                  ...
                  // classListWsController.reconnectWs();
                },
          ...
          children: [
            ...
            Listener( // 修復跑板問題
              ...
              child: DropdownButtonFormField(
                value: classSettingController.selectedClassSetting.value,
                items: classSettingController.classSettingList
                    .map((item) {
                ...
                onChanged: (item) {
                  classSettingController.onChangeSelectedSetting(item as ClassSettingInfo);
                },
